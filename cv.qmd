...
<a href="段晋潮 Tony Duan Resume.docx" download class="btn btn-primary" style="margin-bottom: 1rem;">📥 Download Resume</a>
...
|----------|-------------|
| **AI/ML** | Agentic Workflows, RAG, LLM Integration, YOLO |
| **Data Science** | Python (Pandas, Plotly, Scikit-learn), R (Tidyverse, GGplot2, Tidymodels) |
| **Data Engineering** | SQL (Advanced Querying & Schema Design), Streamlit, Shiny, Quarto |
...
<a href="段晋潮 Tony Duan简历.docx" download class="btn btn-primary" style="margin-bottom: 1rem;">📥 下载简历</a>
